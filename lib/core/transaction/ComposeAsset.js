...
var ComposeAsset = /** @class */ (function (_super) {
    ...
    ComposeAsset.prototype.getComposedAsset = function () {
        ...
        return new Asset_1.Asset({
            ...
            amount: amount == null ? classes_1.U64.ensure(classes_1.U64.MAX_VALUE) : amount,
    ...
    ComposeAsset.prototype.getAssetScheme = function () {
        var _a = this._transaction, networkId = _a.networkId, shardId = _a.shardId, metadata = _a.metadata, inputs = _a.inputs, amount = _a.output.amount, approver = _a.approver, administrator = _a.administrator, allowedScriptHashes = _a.allowedScriptHashes;
        if (amount == null) {
            throw Error("not implemented");
        }
        return new AssetScheme_1.AssetScheme({
            ...
            inputs.reduce(function (acc, input) {
                ...
                acc[assetType.value] = classes_1.U64.plus(acc[assetType.value], assetAmount);
                return acc;
            }, {})).map(function (_a) {
                var _b = __read(_a, 2), assetType = _b[0], assetAmount = _b[1];
                return ({
                    assetType: classes_1.H256.ensure(assetType),
                    amount: classes_1.U64.ensure(assetAmount)
                });
            })
        });
    };
