...
var MintAsset = /** @class */ (function (_super) {
    ...
    MintAsset.prototype.getMintedAsset = function () {
        var _a = this._transaction.output, lockScriptHash = _a.lockScriptHash, parameters = _a.parameters, amount = _a.amount;
        if (amount == null) {
    ...
    MintAsset.prototype.getAssetScheme = function () {
        var _a = this._transaction, networkId = _a.networkId, shardId = _a.shardId, metadata = _a.metadata, amount = _a.output.amount, approver = _a.approver, administrator = _a.administrator, allowedScriptHashes = _a.allowedScriptHashes;
        if (amount == null) {
            throw Error("not implemented");
        }
...
var AssetMintTransaction = /** @class */ (function () {
    ...
    AssetMintTransaction.prototype.toEncodeObject = function () {
        var _a = this, networkId = _a.networkId, shardId = _a.shardId, metadata = _a.metadata, _b = _a.output, lockScriptHash = _b.lockScriptHash, parameters = _b.parameters, amount = _b.amount, approver = _a.approver, administrator = _a.administrator, allowedScriptHashes = _a.allowedScriptHashes;
        return [
            0x13,
            networkId,
            shardId,
