...
var Core = /** @class */ (function () {
    ...
    Core.prototype.createPayTransaction = function (params) {
        ...
        checkAmount(amount);
        return new Pay_1.Pay(codechain_primitives_1.PlatformAddress.ensure(recipient), U64_1.U64.ensure(amount), this.networkId);
    };
    /**
    ...
    Core.prototype.createAssetScheme = function (params) {
        var shardId = params.shardId, metadata = params.metadata, amount = params.amount, _a = params.approver, approver = _a === void 0 ? null : _a, _b = params.administrator, administrator = _b === void 0 ? null : _b, _c = params.allowedScriptHashes, allowedScriptHashes = _c === void 0 ? null : _c, _d = params.pool, pool = _d === void 0 ? [] : _d;
        checkShardId(shardId);
    ...
    Core.prototype.createOrder = function (params) {
        ...
        for (var i = 0; i < originOutputs.length; i++) {
            ...
            var tracker = originOutput.tracker, index = originOutput.index, assetType = originOutput.assetType, amount = originOutput.amount, lockScriptHash = originOutput.lockScriptHash, parameters = originOutput.parameters;
    ...
    Core.prototype.createMintAssetTransaction = function (params) {
        ...
        var _b = scheme.networkId, networkId = _b === void 0 ? this.networkId : _b, shardId = scheme.shardId, metadata = scheme.metadata, _c = scheme.approver, approver = _c === void 0 ? null : _c, _d = scheme.administrator, administrator = _d === void 0 ? null : _d, _e = scheme.allowedScriptHashes, allowedScriptHashes = _e === void 0 ? null : _e, amount = scheme.amount;
    ...
    Core.prototype.createTransferAssetTransaction = function (params) {
        var _a = params || {}, _b = _a.burns, burns = _b === void 0 ? [] : _b, _c = _a.inputs, inputs = _c === void 0 ? [] : _c, _d = _a.outputs, outputs = _d === void 0 ? [] : _d, _e = _a.orders, orders = _e === void 0 ? [] : _e, _f = _a.networkId, networkId = _f === void 0 ? this.networkId : _f, _g = _a.approvals, approvals = _g === void 0 ? [] : _g;
    ...
    Core.prototype.createAssetTransferInput = function (params) {
        ...
        var tracker = assetOutPoint.tracker, index = assetOutPoint.index, assetType = assetOutPoint.assetType, amount = assetOutPoint.amount, lockScriptHash = assetOutPoint.lockScriptHash, parameters = assetOutPoint.parameters;
    ...
    Core.prototype.createAssetOutPoint = function (params) {
        var tracker = params.tracker, index = params.index, assetType = params.assetType, amount = params.amount;
...
function checkAssetOutPoint(value) {
    ...
    var tracker = value.tracker, index = value.index, assetType = value.assetType, amount = value.amount, lockScriptHash = value.lockScriptHash, parameters = value.parameters;
    checkTracker(tracker);
    checkIndex(index);
    checkAssetType(assetType);
    checkAmount(amount);
