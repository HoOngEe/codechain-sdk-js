...
var Asset = /** @class */ (function () {
    function Asset(data) {
        var tracker = data.tracker, transactionOutputIndex = data.transactionOutputIndex, assetType = data.assetType, amount = data.amount, _a = data.orderHash, orderHash = _a === void 0 ? null : _a, lockScriptHash = data.lockScriptHash, parameters = data.parameters;
    ...
    Asset.fromJSON = function (data) {
        var assetType = data.assetType, lockScriptHash = data.lockScriptHash, parameters = data.parameters, amount = data.amount, orderHash = data.orderHash, tracker = data.tracker, transactionOutputIndex = data.transactionOutputIndex;
        return new Asset({
    ...
    Asset.prototype.createTransferTransaction = function (params) {
        ...
        var _b = params.recipients, recipients = _b === void 0 ? [] : _b, _c = params.timelock, timelock = _c === void 0 ? null : _c, networkId = params.networkId, _d = params.approvals, approvals = _d === void 0 ? [] : _d;
